...
import com.autoai.android.download.DownloadHelper;
            ...
            if (null != intent){
                ...
                switch (action){
                    case FIRST_ACTION: {
                        ...
                        LogUtil.e(TAG, "action=" + action + ", download_status=" + DebugUtils.getStatusDesc(firstFileInfo.getDownloadStatus()));
                    ...
                    case SECOND_ACTION: {
                        ...
                        LogUtil.e(TAG, "action=" + action + ", download_status=" + DebugUtils.getStatusDesc(secondFileInfo.getDownloadStatus()));
                    ...
                    case THIRD_ACTION: {
                        ...
                        LogUtil.e(TAG, "action=" + action + ", download_status=" + DebugUtils.getStatusDesc(thirdFileInfo.getDownloadStatus()));
...
//        if (fileInfo.getDownloadStatus() == DownloadStatus.WAIT) {
//            Log.e(TAG, "updateTextview: download status is wait.");
//        }
//        if (fileInfo.getDownloadStatus() == DownloadStatus.PREPARE) {
//            Log.e(TAG, "updateTextview: download status is prepare.");
//        }
